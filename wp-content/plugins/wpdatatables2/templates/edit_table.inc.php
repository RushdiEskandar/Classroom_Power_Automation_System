								...
								<div class="inside">
									<table class="form-table wpDataTables">
											...
											<tr valign="top" class="step1_row">
												...
												<td>
													<select name="wpTableType" id="wpTableType" class="wpDataTables">
														...
														<option <?php //[<-- Full version insertion #08 -->]// ?> value="mysql" <?php if (!empty($table_data['table_type']) && $table_data['table_type'] == 'mysql') {
															?>selected="selected"<?php } ?>><?php _e('MySQL
														query','wpdatatables');?><?php //[<-- Full version insertion #26 -->]// ?></option>
													
														<option <?php //[<-- Full version insertion #08 -->]// ?> value="google_spreadsheet" <?php if (!empty($table_data['table_type']) && $table_data['table_type'] == 'google_spreadsheet') {
														?>selected="selected"<?php } ?>><?php _e('Google spreadsheet','wpdatatables');?><?php //[<-- Full version insertion #26 -->]// ?></option>
										...
										<tr valign="top" class="table_editable_row step1_row">
											<th scope="row">
												<label for="wpTableEditable"><?php _e('Front-end editing','wpdatatables');?><?php //[<-- Full version insertion #18 -->]// ?></label>
											</th>
											<td>
												<input type="checkbox" <?php //[<-- Full version insertion #08 -->]// ?> <?php if( empty( $table_id ) ) { ?>disabled="disabled"<?php } ?> id="wpTableEditable"
										...
										<tr valign="top" class="step1_row serverside_row">
											<th scope="row">
												<label for="wpServerSide"><?php _e('Server-side processing','wpdatatables');?><?php //[<-- Full version insertion #18 -->]// ?></label>
											</th>
											<td>
												<input type="checkbox" <?php //[<-- Full version insertion #08 -->]// ?> id="wpServerSide" <?php if (isset($table_data['server_side']) && $table_data['server_side']) {
												?>checked="checked"<?php } ?> />
										...
										<tr valign="top" class="step1_row">
											<th scope="row">
												<label for="wdtResponsive"><?php _e('Responsive','wpdatatables');?><?php //[<-- Full version insertion #18 -->]// ?></label>
											</th>
											<td>
												<input type="checkbox" <?php //[<-- Full version insertion #08 -->]// ?> id="wdtResponsive" <?php if (isset($table_data['responsive']) && $table_data['responsive']) {
												?>checked="checked"<?php } ?> />
										...
										<tr valign="top" class="step1_row">
											<th scope="row">
												<label for="wpAdvancedFilter"><?php _e('Advanced filtering','wpdatatables');?><?php //[<-- Full version insertion #18 -->]// ?></label>
											</th>
											<td>
												<input type="checkbox" <?php //[<-- Full version insertion #08 -->]// ?> id="wpAdvancedFilter" <?php if (!isset($table_data['filtering']) || $table_data['filtering']) {
												//[<-- Full version -->]//	?>checked="checked"<?php //[<--/ Full version -->]//
												 } ?> />
										...
										<tr valign="top" class="step1_row">
											<th scope="row">
												<label for="wpAdvancedFilterForm"><?php _e('Filter in form','wpdatatables');?><?php //[<-- Full version insertion #18 -->]// ?></label>
											</th>
											<td>
												<input type="checkbox" <?php //[<-- Full version insertion #08 -->]// ?> id="wpAdvancedFilterForm" <?php if (isset($table_data['filtering_form']) &&
